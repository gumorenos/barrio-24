...
const modules = [
  ...
  },
  {
    ...
    description: 'Comunica una necesidad con pocos pasos.',
    state: 'Próximamente',
  },
  {
    icon: MapPinned,
    ...
    <div className="app-shell">
      ...
      <main>
        <section className="hero" aria-labelledby="hero-title">
          <div className="eyebrow"><span className="eyebrow-dot" /> Fase 0 · base offline-first</div>
          <div className="hero-grid">
            ...
            <aside className="hero-note" aria-label="Estado de la fase 0">
              <div className="note-icon"><ShieldCheck size={22} aria-hidden="true" /></div>
              <p className="note-kicker">Hito verificable</p>
              <p className="note-title">Los datos locales sobreviven a la pérdida de conexión.</p>
              <p className="note-body">Esta demostración usa datos sintéticos. Todavía no se envía información a un backend.</p>
            </aside>
          </div>
        </section>
